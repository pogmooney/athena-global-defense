#!/usr/bin/env python3
"""WorldwideProtectionNetworkApp - Global Deployment Application"""
...
if __name__ == "__main__":
    app = WorldwideProtectionNetworkApp()
